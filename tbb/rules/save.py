...
def _battle(b):
    return {"attacker":b.attacker.pid,"defender":b.defender.pid,"assault":b.assault,
            "contact_kind":b.contact_kind,"battle_kind":b.battle_kind,
