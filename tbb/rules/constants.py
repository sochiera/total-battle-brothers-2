...
MAP_WIDTH, MAP_HEIGHT = 46, 34
# Crossing the long axis on the cheapest legal path costs at least this many
# movement points (a 46-wide map of cost-1+ hexes cannot be crossed faster).
LONG_AXIS_MIN_MP = 20
...
CAMPAIGN_TERRAINS = (TERRAIN_PLAINS, TERRAIN_FOREST, TERRAIN_HILLS,
                     ...
                     TERRAIN_FARMLAND, TERRAIN_COAST)
...
BATTLE_WIDTH, BATTLE_HEIGHT = 18, 13
